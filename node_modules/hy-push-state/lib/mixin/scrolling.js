    ...
    _createClass(_class, [{
      ...
      value: function scrollHashIntoView(hash, options) {
        if (hash) {
          ...
          if (el) el.scrollIntoView(options);else if (process.env.DEBUG) console.warn("Can't find element with id ".concat(hash));
        } else {
      ...
      value: function restoreScrollPostionOnReload() {
        var userHasScrolled = (0, _common.getScrollTop)() != 0;
...
exports.scrollMixin = scrollMixin;