  ...
  return /*#__PURE__*/function (_C) {
    ...
    _createClass(_class, [{
      ...
      value: function isPushEvent(_ref) {
        ...
        return !metaKey && !ctrlKey && this.shouldLoadAnchor(anchor, this.hrefRegex) && !(0, _common.isExternal)(url, this);
      }
    }, {
      key: "isHintEvent",
      value: function isHintEvent(_ref2) {
        var url = _ref2.url,
            anchor = _ref2.anchor;
        return this.shouldLoadAnchor(anchor, this.hrefRegex) && !(0, _common.isExternal)(url, this) && !(0, _common.isHash)(url, this);
      ...
      value: function isHashChange(_ref3) {
        ...
        return pathname === prevPathname && (type === _constants.POP || type === _constants.PUSH && hash !== "");
      }
    }]);
...
exports.helperMixin = helperMixin;